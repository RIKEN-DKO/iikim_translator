...
from spanat.prompt import base_trans_prompt as prompt

#%%
# Setup command-line argument parsing
parser = argparse.ArgumentParser(description="Train a multilingual M2M model")
...
def preprocess_function(examples, source_lang, target_lang):
    ...
    inputs = [
        prompt(source_lang,target_lang,source_text=example[source_lang] ) 
...
if config.get('uniform_sample',False):
