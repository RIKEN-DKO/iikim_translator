...
source_lang="spanish"
model="assets/SpaNat_groups_openLLama/C2_maya_chol"
...
for target_lang in "${languages[@]}"; do
    ...
    python -m translator.testLLama --model_path $model --base_data_dir data/indi_langs_clean --source_lang $source_lang --target_lang $target_lang
done
