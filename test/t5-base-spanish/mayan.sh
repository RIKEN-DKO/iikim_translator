...
source_lang="spanish"
model="assets/t5-base-spanish/mayan"
...
for target_lang in "${languages[@]}"; do
    ...
    python -m spanat.testT5 --model_path $model --base_data_dir data/mayan --source_lang $source_lang --target_lang $target_lang --append_mode a
done
