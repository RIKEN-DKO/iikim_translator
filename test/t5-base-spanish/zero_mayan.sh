...
source_lang="spanish"
model="vgaraujov/t5-base-spanish"
...
for target_lang in "${languages[@]}"; do
    ...
    python -m spanat.testT5 --model_path $model --base_data_dir data/otomay --source_lang $source_lang --target_lang $target_lang --append_mode a --from_hf
done
