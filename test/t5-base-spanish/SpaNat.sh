...
for target_lang in "${languages[@]}"; do
    ...
    python -m translator.testT5 --model_path assets/t5-base-spanish/SpaNat --base_data_dir data/indi_langs_clean --source_lang $source_lang --target_lang $target_lang --append_mode a
done
